...
-- Admin user (password = "ChangeMe123!" — bcrypt hash, MUST be rotated on first login)
INSERT INTO users (email, password_hash, name, role, is_active) VALUES
('admin@koreaautoexport.dz',
 '$2y$12$wM7eR/Y8z9Q3vKf6n4xRYO5xX2pZ9j1qQ3oS5dN0lE7uV8aB1cD2e',  -- placeholder; regenerate in seed step
 'Site Administrator', 'admin', 1);
